        ...
        <div class="forms">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> <!--php form-->
                ...
                <label for="comments">Message:</label><br>
                    <textarea id="message" name="message" cols="40" rows="10" placeholder="Enter message"></textarea><br><br>
...
if(isset($_POST["submit"])) {
    ...
    $hostname='sql304.epizy.com'; //optional
    $username = "epiz_30429118";
    $password = "9Hqz2DV7quf";

    $connection_info = "mysql:host=sql304.epizy.com; dbname=epiz_30429118_test1";
    ...
    try {
        ...
        $sql = "INSERT INTO user_input (name, email, message)
            VALUES (' ".$_POST["name"]." ' , ' ".$_POST["email"]." ' , ' ".$_POST["message"]." ')";//<==notice the use of quotes here
